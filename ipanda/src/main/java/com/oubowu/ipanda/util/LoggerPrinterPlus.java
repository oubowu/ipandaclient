...
/**
 * Created by Oubowu on 2017/12/21 22:35.
 */
public class LoggerPrinterPlus implements Printer{
    ...
    @Override public void d(Object object) {
        // log(DEBUG, null, LoggerInfoUtils.toString(object));
        log(ERROR, null, LoggerInfoUtils.toString(object));
    }
    ...
    @Override public void json(String json) {
        if (LoggerInfoUtils.isEmpty(json)) {
    ...
    @Override public void xml(String xml) {
        if (LoggerInfoUtils.isEmpty(xml)) {
    ...
    @Override public synchronized void log(int priority, String tag, String message, Throwable throwable) {
        if (throwable != null && message != null) {
            message += " : " + LoggerInfoUtils.getStackTraceString(throwable);
        }
        if (throwable != null && message == null) {
            message = LoggerInfoUtils.getStackTraceString(throwable);
        }
        if (LoggerInfoUtils.isEmpty(message)) {
